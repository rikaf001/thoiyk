...
@TableGenerator( // SCOPE is Global to PU
    ...
    pkColumnValue="GEN_BRNGKELBAKU_DTL", 
    allocationSize=1)    
@Table(name = "BARANGKELUARBAKU_DTL")
public class BarangKeluarBakuDetailClass 
extends KBusinessObjectClass
{
    ...
    public BarangKeluarBakuDetailClass() throws KExceptionClass{
    }
