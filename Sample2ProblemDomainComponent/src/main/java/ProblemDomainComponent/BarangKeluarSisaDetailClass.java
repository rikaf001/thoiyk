...
@TableGenerator( // SCOPE is Global to PU
    ...
    pkColumnValue="GEN_BRNGKELSISA_DTL", 
    allocationSize=1)    
@Table(name = "BARANGKELUARSISA_DTL")
public class BarangKeluarSisaDetailClass 
extends KBusinessObjectClass
{
    ...
    public BarangKeluarSisaDetailClass() throws KExceptionClass{
    }
