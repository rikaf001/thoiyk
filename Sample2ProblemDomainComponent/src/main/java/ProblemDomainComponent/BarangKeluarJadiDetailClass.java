...
@TableGenerator( // SCOPE is Global to PU
    ...
    pkColumnValue="GEN_BRNGKELJADI_DTL", 
    allocationSize=1)    
@Table(name = "BARANGKELUARJADI_DTL")
public class BarangKeluarJadiDetailClass 
extends KBusinessObjectClass
{
    ...
    public BarangKeluarJadiDetailClass() throws KExceptionClass{
    }
