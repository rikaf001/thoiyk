...
public class KTransactionClass {
                ...
                String SESSION_IDParam, String persistentUnitName ) throws KExceptionClass
        {
            ...
            // has
            logParam.log( this, ">>> TRANSACTION CONNECTING v2 --" );     
            activeSQLStatements = new ArrayList< PreparedStatement >();    

            try{

                // get a JPA factory
factory = OpenJPAPersistence.createEntityManagerFactory( persistentUnitName, (String) null ); 
          ...
          log.log( this, "<<< TRANSACTION CLOSING --" );     
            ...
            try{
                ...
                try {
                    ...
                    // designed to have many and do not keep them..
                    
                    factory.close();             

                }catch( Exception error ){
                    log.log( this, "Close factory...  " + error.toString() );
                }                        
