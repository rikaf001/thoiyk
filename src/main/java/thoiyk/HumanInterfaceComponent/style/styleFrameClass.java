 ...
 */
public class styleFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private styleBrowserClass                browser;
	...
	// has defaulted
	browser =  new styleBrowserClass( configuration, log, 
