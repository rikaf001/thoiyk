...
public class mesinFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private mesinBrowserClass             browser;
    ...
    public mesinFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new mesinBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
