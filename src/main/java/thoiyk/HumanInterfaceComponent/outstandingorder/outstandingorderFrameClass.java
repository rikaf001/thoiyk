 ...
 */
public class outstandingorderFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private outstandingorderBrowserClass                browser;
	...
	// has defaulted
	browser =  new outstandingorderBrowserClass( configuration, log, 
