 ...
 */
public class matauangFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private matauangBrowserClass                browser;
	...
	// has defaulted
	browser =  new matauangBrowserClass( configuration, log, 
        ...
        log.log( this, "Matuang frame constructed successfully." );     
    }            
