...
public class accessoriesFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private accessoriesBrowserClass             browser;
    ...
    public accessoriesFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new accessoriesBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
