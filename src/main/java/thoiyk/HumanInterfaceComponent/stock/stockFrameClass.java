...
public class stockFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private stockBrowserClass             browser;
    ...
    public stockFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new stockBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
