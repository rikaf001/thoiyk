...
public class fabricFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private fabricBrowserClass             browser;
    ...
    public fabricFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new fabricBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
