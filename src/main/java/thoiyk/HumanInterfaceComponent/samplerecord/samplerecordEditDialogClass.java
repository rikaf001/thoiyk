...
import thoiyk.HumanInterfaceComponent.samplerecorditem.samplerecorditemBrowserClass;


public class samplerecordEditDialogClass 
...
implements  KDialogInterface, KDialogControllerClass.KDialogEventCallbackInterface
{
    ...
    // has defaulted   
    private samplerecorditemBrowserClass             browser;   
    ...
    public samplerecordEditDialogClass( 
        ...
        throws KExceptionClass
    {
      ...
      /*  
        KDialogController = new KDialogControllerClass(                 
                configuration, log, 
                samplerecordClass.class, this, getContentPane() );        
        */
          KDialogController = new KDialogControllerClass(                 
    ...
    public void initializeDialog(int dialogModeParam, Long ID, Map foreingKeys ) throws KExceptionClass {
        ...
        KDropDownFillerClass statusComboFiller = new KDropDownFillerClass(
                        ...
                        " select ID,  NAMA from samplerecordstatus ",
                        "ID", cbSamplerecordstatus, "samplerecordstatusid"
                        );
    ...
    throws KExceptionClass
    {
       ...
       browser = new samplerecorditemBrowserClass(
                configuration, log, FacturasBrowserJTable, 
                samplerecorditemBrowserClass.SRITEM_BY_SR, id, this );
    ...
    private void initComponents() {
        ...
        cbSamplerecordstatus = new javax.swing.JComboBox();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Sample Record Data", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 10))); // NOI18N
        ...
        cbSamplerecordstatus.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        cbSamplerecordstatus.setName("cbSamplerecordstatus"); // NOI18N
        cbSamplerecordstatus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbSamplerecordstatusActionPerformed(evt);
            }
        });
        ...
        client_name1.setName("style"); // NOI18N
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jLabel12)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(cbSamplerecordstatus, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 172, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .add(16, 16, 16))
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                    .add(client_name1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE)
                                    .add(client_name)))
                            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel12)
                            .add(cbSamplerecordstatus, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .add(16, 16, 16)
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel11)
        ...
        jPanel1.setBounds(0, 60, 510, 260);
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void cbSamplerecordstatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbSamplerecordstatusActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbSamplerecordstatusActionPerformed
...
public void loadPic(){
    ...
    private javax.swing.JComboBox cbSamplerecordstatus;
...
// these are activated as we implement KDialogEventCallbackInterface
    ...
    public void postEdit(KBusinessObjectClass businessObject) throws Exception {
        ...
        samplerecordClass product = (samplerecordClass) businessObject;
