...
public class JenisDokPabeanFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private JenisDokPabeanBrowserClass             browser;
    ...
    public JenisDokPabeanFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new JenisDokPabeanBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
