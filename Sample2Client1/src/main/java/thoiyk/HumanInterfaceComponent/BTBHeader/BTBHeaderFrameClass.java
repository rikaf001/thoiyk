...
public class BTBHeaderFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BTBHeaderBrowserClass             browser;
    ...
    public BTBHeaderFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BTBHeaderBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
