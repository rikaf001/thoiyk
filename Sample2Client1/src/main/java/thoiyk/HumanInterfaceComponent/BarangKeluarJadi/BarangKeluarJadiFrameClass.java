...
public class BarangKeluarJadiFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangKeluarJadiBrowserClass             browser;
    ...
    public BarangKeluarJadiFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangKeluarJadiBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
