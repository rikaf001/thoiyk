 ...
 */
public class ServiceTypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private ServiceTypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new ServiceTypeBrowserClass( configuration, log, 
        ...
        log.log( this, "Service Type frame constructed successfully." );     
    }            
