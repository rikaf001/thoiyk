...
// uses
    ...
    // has defaulted   
    private FormCuttingDetailBrowserClass             browser;   
    ...
    public FormCuttingHeaderEditDialogClass( 
...
//        JCalendarDemoWidgetAdapterClass dateChooserAdapter3 = new JCalendarDemoWidgetAdapterClass( jDateChooser3, "TglSJ" );                
 ...
 //       JCalendarDemoWidgetAdapterClass dateChooserAdapter4 = new JCalendarDemoWidgetAdapterClass( jDateChooser4, "TglBC" );                
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new FormCuttingDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                FormCuttingDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Form Cutting", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 10))); // NOI18N
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   FormCuttingHeadersamplerecordClassClass po = new FormCuttingHeaderClass();
         //   po = (FormCuttingHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //FormCuttingHeaderClass po = new FormCuttingHeaderClass();
            FormCuttingHeaderClass ProdIn = ( FormCuttingHeaderClass ) POM.copy4( ((FormCuttingHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), FormCuttingHeaderClass.class );
...
//            FormCuttingTypeClass ProdInType = ( FormCuttingTypeClass ) POMProdInType.copy4( ProdIn.getTypeID(), FormCuttingTypeClass.class );
            ...
            //FormCuttingHeaderTermClass poterm = new FormCuttingHeaderTermClass();
            //poterm = (FormCuttingHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), FormCuttingHeaderTermClass.class );  
