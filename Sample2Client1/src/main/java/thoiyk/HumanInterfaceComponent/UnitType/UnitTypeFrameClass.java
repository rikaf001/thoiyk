 ...
 */
public class UnitTypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private UnitTypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new UnitTypeBrowserClass( configuration, log, 
