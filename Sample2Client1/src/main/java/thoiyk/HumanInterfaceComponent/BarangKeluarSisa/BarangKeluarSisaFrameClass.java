...
public class BarangKeluarSisaFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangKeluarSisaBrowserClass             browser;
    ...
    public BarangKeluarSisaFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangKeluarSisaBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
