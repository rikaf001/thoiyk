...
package thoiyk.HumanInterfaceComponent.BarangKeluarSisa;
...
import ProblemDomainComponent.BarangKeluarSisaClass;
import ProblemDomainComponent.buyerClass;
import ProblemDomainComponent.outstandingorderClass;
import java.awt.Font;
import java.awt.print.PageFormat;
import thoiyk.HumanInterfaceComponent.BarangKeluarSisaDetail.BarangKeluarSisaDetailBrowserClass;
...
public class BarangKeluarSisaEditDialogClass 
...
// uses
    ...
    // has defaulted   
    private BarangKeluarSisaDetailBrowserClass             browser;   
    ...
    public BarangKeluarSisaEditDialogClass( 
        ...
        throws KExceptionClass
{
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new BarangKeluarSisaDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                BarangKeluarSisaDetailBrowserClass.POITEM_BY_PO, 
                id,
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BarangKeluarSisasamplerecordClassClass po = new BarangKeluarSisaClass();
         //   po = (BarangKeluarSisaClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //BarangKeluarSisaClass po = new BarangKeluarSisaClass();
            BarangKeluarSisaClass ProdIn = ( BarangKeluarSisaClass ) POM.copy4( ((BarangKeluarSisaClass)KDialogController.getCurrentObjectDisplayed()).getID(), BarangKeluarSisaClass.class );
            ...
            //BarangKeluarSisaTermClass poterm = new BarangKeluarSisaTermClass();
            //poterm = (BarangKeluarSisaTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BarangKeluarSisaTermClass.class );  
