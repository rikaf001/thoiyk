...
public class DailySewingHdrFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private DailySewingHdrBrowserClass             browser;
    ...
    public DailySewingHdrFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new DailySewingHdrBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
