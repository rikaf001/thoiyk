...
public class sparepartFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private sparepartBrowserClass             browser;
    ...
    public sparepartFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new sparepartBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
