...
public class MarkerFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private MarkerBrowserClass             browser;
    ...
    public MarkerFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new MarkerBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
