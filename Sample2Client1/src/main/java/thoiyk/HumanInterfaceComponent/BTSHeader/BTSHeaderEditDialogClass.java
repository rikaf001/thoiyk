...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BTSHeadersamplerecordClassClass po = new BTSHeaderClass();
         //   po = (BTSHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  
            ...
            BTSHeaderClass ProdIn = ( BTSHeaderClass ) POM.copy4( ((BTSHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), BTSHeaderClass.class );
            
            //materialize Product In Type
  //          persistentObjectManagerClass POMProdInType = new persistentObjectManagerClass(configuration, log);
//            BTSTypeClass ProdInType = ( BTSTypeClass ) POMProdInType.copy4( ProdIn.getTypeID(), BTSTypeClass.class );
            ...
            //BTSHeaderTermClass poterm = new BTSHeaderTermClass();
            //poterm = (BTSHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BTSHeaderTermClass.class );  
