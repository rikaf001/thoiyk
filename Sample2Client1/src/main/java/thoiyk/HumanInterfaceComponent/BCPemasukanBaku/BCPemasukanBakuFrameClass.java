...
public class BCPemasukanBakuFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BCPemasukanBakuBrowserClass             browser;
    ...
    public BCPemasukanBakuFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BCPemasukanBakuBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
