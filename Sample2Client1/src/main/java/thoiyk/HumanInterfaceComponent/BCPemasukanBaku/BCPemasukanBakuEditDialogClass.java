...
import ProblemDomainComponent.v_BC_PemasukanBakuClass;
...
import thoiyk.HumanInterfaceComponent.BCPemasukanBakuDetail.BCPemasukanBakuDetailBrowserClass;
...
// uses
    ...
    // has defaulted   
    private BCPemasukanBakuDetailBrowserClass             browser;   
        ...
        throws KExceptionClass
{
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new BCPemasukanBakuDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                BCPemasukanBakuDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Pemasukan Bahan Baku & Penolong", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 10))); // NOI18N
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(client_id7, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 146, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    ...
                                    .add(client_id8, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 146, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .add(client_id9, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 146, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
  ...
  private void CloseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CloseButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BCPemasukanBakusamplerecordClassClass po = new BCPemasukanBakuClass();
         //   po = (BCPemasukanBakuClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //BCPemasukanBakuClass po = new BCPemasukanBakuClass();
          //  BCPemasukanBakuClass ProdIn = ( BCPemasukanBakuClass ) POM.copy4( ((BCPemasukanBakuClass)KDialogController.getCurrentObjectDisplayed()).getID(), BCPemasukanBakuClass.class );
            ...
            //BCPemasukanBakuTermClass poterm = new BCPemasukanBakuTermClass();
            //poterm = (BCPemasukanBakuTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BCPemasukanBakuTermClass.class );  
