...
package thoiyk.HumanInterfaceComponent.MutasiMesin;


//K
import thoiyk.HumanInterfaceComponent.MutasiMesin.*;
...
import thoiyk.HumanInterfaceComponent.v_Select_MutasiMesin.v_Select_MutasiMesinBrowserClass;


public class MutasiMesinEditDialogClass
...
implements  KDialogInterface, KDialogEventCallbackInterface
{
    ...
    public MutasiMesinEditDialogClass( 
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Mutasi Mesin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11))); // NOI18N
  ...
  private void CloseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CloseButtonActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            v_Select_MutasiMesinBrowserClass selectBrowser = new v_Select_MutasiMesinBrowserClass(
            ...
            else
            {
               ...
               // v_Select_MutasiMesinClass baku = new v_Select_MutasiMesinClass();
               v_Select_MutasiMesinClass baku = ( v_Select_MutasiMesinClass ) POM1.copy4( parentID, v_Select_MutasiMesinClass.class );
