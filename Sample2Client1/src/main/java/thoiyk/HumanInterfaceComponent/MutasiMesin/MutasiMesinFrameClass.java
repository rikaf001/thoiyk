...
public class MutasiMesinFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private MutasiMesinBrowserClass             browser;
    ...
    public MutasiMesinFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new MutasiMesinBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
