 ...
 */
public class ThreadFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private ThreadBrowserClass                browser;
	...
	// has defaulted
	browser =  new ThreadBrowserClass( configuration, log, 
