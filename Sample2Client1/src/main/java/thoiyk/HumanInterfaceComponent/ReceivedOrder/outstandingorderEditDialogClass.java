...
import thoiyk.HumanInterfaceComponent.ReceivedOrderItem.reservedorderitemBrowserClass;
...
//        setSize( 630, 600 );
        ...
        KDialogController = new KDialogControllerClass(                 
                configuration, log, 
                ReceivedOrderClass.class, this, getContentPane() );        
    ...
    public void initializeDialog(int dialogModeParam, Long ID, Map foreingKeys ) throws KExceptionClass {
        ...
        //-------------------------------------------------------------                           
                ...
                JCalendarDemoWidgetAdapterClass dateChooserAdapter = new JCalendarDemoWidgetAdapterClass( dShipDate, "shipdate" );                
                KDialogController.includeCustomWidgetForMapping( dateChooserAdapter );                
                //-------------------------------------------------------------                           
                        
                JCalendarDemoWidgetAdapterClass prodIn = new JCalendarDemoWidgetAdapterClass( dProdIn, "productin" );                
                KDialogController.includeCustomWidgetForMapping( prodIn );                
                //-------------------------------------------------------------     
                
                JCalendarDemoWidgetAdapterClass prodOut = new JCalendarDemoWidgetAdapterClass( dProdOut, "productout" );                
                KDialogController.includeCustomWidgetForMapping( prodOut );                
                //-------------------------------------------------------------   
        // start
...
/*        try
  ...
  */                      
    ...
    private void initComponents() {
        ...
        dShipDate = new com.toedter.calendar.JDateChooser();
        ...
        dProdIn = new com.toedter.calendar.JDateChooser();
        dProdOut = new com.toedter.calendar.JDateChooser();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Received Order", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 3, 10))); // NOI18N
        ...
        jLabel2.setText("Production Out");
        ...
        dShipDate.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        dShipDate.setName("shipDate1"); // NOI18N

        lblHp1.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        ...
        toleranceLabel2.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        ...
        dProdIn.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        dProdIn.setName("dProdIn"); // NOI18N

        dProdOut.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        dProdOut.setName("dProdOut"); // NOI18N
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(buyernameLbl, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 167, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            ...
                            .add(dShipDate, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            ...
                            .add(dProdIn, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(dProdOut, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(lblHp1)
                    .add(dShipDate, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jLabel1)
                    .add(dProdIn, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(jLabel2)
                    .add(dProdOut, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(jLabel3)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 102, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private com.toedter.calendar.JDateChooser dProdIn;
    private com.toedter.calendar.JDateChooser dProdOut;
    private com.toedter.calendar.JDateChooser dShipDate;
