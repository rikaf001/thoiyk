...
public class MutasiJadiFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private MutasiJadiBrowserClass             browser;
    ...
    public MutasiJadiFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new MutasiJadiBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
