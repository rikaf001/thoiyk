...
public class MutasiBakuFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private MutasiBakuBrowserClass             browser;
    ...
    public MutasiBakuFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new MutasiBakuBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
