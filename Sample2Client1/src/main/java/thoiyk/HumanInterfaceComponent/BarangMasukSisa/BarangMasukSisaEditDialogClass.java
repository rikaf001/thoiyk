...
import ProblemDomainComponent.BarangMasukSisaClass;
...
import thoiyk.HumanInterfaceComponent.BarangMasukSisaDetail.BarangMasukSisaDetailBrowserClass;
...
public class BarangMasukSisaEditDialogClass 
...
// uses
    ...
    // has defaulted   
    private BarangMasukSisaDetailBrowserClass             browser;   
    ...
    public BarangMasukSisaEditDialogClass( 
        ...
        throws KExceptionClass
{
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new BarangMasukSisaDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                BarangMasukSisaDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Barang Masuk Sisa", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 10))); // NOI18N
        ...
        Supplier_Text04Edit1.setName("Nomor"); // NOI18N
        ...
        jPanel1.setBounds(0, 50, 660, 170);
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .addContainerGap()
                .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 246, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(1, 1, 1)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BarangMasukSisasamplerecordClassClass po = new BarangMasukSisaClass();
         //   po = (BarangMasukSisaClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //BarangMasukSisaClass po = new BarangMasukSisaClass();
            BarangMasukSisaClass ProdIn = ( BarangMasukSisaClass ) POM.copy4( ((BarangMasukSisaClass)KDialogController.getCurrentObjectDisplayed()).getID(), BarangMasukSisaClass.class );
            ...
            //BarangMasukSisaTermClass poterm = new BarangMasukSisaTermClass();
            //poterm = (BarangMasukSisaTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BarangMasukSisaTermClass.class );  
