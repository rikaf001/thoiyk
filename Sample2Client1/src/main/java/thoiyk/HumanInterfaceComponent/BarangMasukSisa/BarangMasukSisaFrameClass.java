...
public class BarangMasukSisaFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangMasukSisaBrowserClass             browser;
    ...
    public BarangMasukSisaFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangMasukSisaBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
