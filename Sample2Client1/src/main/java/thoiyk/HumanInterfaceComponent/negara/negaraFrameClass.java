 ...
 */
public class negaraFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private negaraBrowserClass                browser;
	...
	// has defaulted
	browser =  new negaraBrowserClass( configuration, log, 
