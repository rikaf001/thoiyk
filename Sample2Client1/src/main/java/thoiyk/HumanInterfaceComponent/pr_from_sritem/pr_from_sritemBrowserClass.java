...
package thoiyk.HumanInterfaceComponent.pr_from_sritem;
...
//rtl
import thoiyk.HumanInterfaceComponent.pr_from_sritem.*;
import javax.swing.*;
import java.awt.*;
...
// system
import ProblemDomainComponent.pr_from_sritemClass;
import thoiyk.HumanInterfaceComponent.pr_from_sr.pr_from_srBrowserClass;
import static thoiyk.HumanInterfaceComponent.pr_from_sritem.pr_from_sritemBrowserClass.ALL_SAMPLERECORD;
import static thoiyk.HumanInterfaceComponent.pr_from_sritem.pr_from_sritemBrowserClass.SRITEM_BY_SR;
import thoiyk.HumanInterfaceComponent.pr_from_sritem.pr_from_sritemEditDialogClass;
...
public class pr_from_sritemBrowserClass 
...
{   
    ...
    public pr_from_sritemBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    pr_from_sritemClass.class,
                    pr_from_sritemEditDialogClass.class
            );  
            ...
            if( mode == SRITEM_BY_SR ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " sri.id , sri.itemid, vsri.category,vsri.nama as name,  sri.qtyneed ",    

                        // 2 tables and joins                                                
                        " samplerecorditem sri " +
                        " left join v_sr_item vsri on sri.itemid=vsri.id " +
                        " left join productionrecord pr on sri.samplerecordid=pr.selectid and pr.selectid>0 "    ,
                       //     +
                        "ID"
                            );    
                ...
                setColumnNames( "vsri", "NAME", "Name" );
                setColumnNames( "sri", "QTYNEED", "QtyNeed" );
                
                setDefaultCriteria( " pr.id = ? " );               
                bindDefaultParameter1( ":pr.id",  parentID  );     
                ...
                // when not inside a client edit dialog
                        ...
                        if( mode == ALL_SAMPLERECORD ){
                            ...
                            // build a client browser
                               pr_from_srBrowserClass pr_from_sr = new pr_from_srBrowserClass(
                                        configuration, log, new javax.swing.JTable(), getParentWindow() );

                               pr_from_sr.initializeTable();   


                               selectDialogClass selector = new selectDialogClass( 
                                       configuration, log, getParentWindow(), pr_from_sr, "Select Production Record Item" );
                               ...
                               if( parentID == -1 ) throw new KExceptionClass( "You must select a production record for the pr_from_sritem!", null);
                        }
