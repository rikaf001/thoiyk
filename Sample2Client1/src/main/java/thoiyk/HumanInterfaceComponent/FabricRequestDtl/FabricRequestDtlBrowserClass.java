...
public class FabricRequestDtlBrowserClass 
...
{   
    ...
    public FabricRequestDtlBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    FabricRequestDtlClass.class,
                    FabricRequestDtlEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.jeniskain name, dtl.warna, sup.nama supplier,vsr.category type, dtl.qtyneed qty, dtl.qtyallowance allowance, dtl.qtyneedtotal totalqty, dtl.kainreceived received, dtl.kainneeded needed, dtl.kainplusmin, dtl.kainpersen, dtl.keterangan ",    
