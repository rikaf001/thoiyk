...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BKSHeadersamplerecordClassClass po = new BKSHeaderClass();
         //   po = (BKSHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  
            ...
            BKSHeaderClass ProdOut = ( BKSHeaderClass ) POM.copy4( ((BKSHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), BKSHeaderClass.class );
...
//            BKSTypeClass ProdOutType = ( BKSTypeClass ) POMProdOutType.copy4( ProdOut.getTypeID(), BKSTypeClass.class );
...
//            v_PenerimaClass Supp = ( v_PenerimaClass ) POMSupp.copy4( ProdOut.getPenerimaID(), v_PenerimaClass.class );
            ...
            //BKSHeaderTermClass poterm = new BKSHeaderTermClass();
            //poterm = (BKSHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BKSHeaderTermClass.class );  
