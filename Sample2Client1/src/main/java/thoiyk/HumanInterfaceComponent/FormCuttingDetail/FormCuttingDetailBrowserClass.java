...
public class FormCuttingDetailBrowserClass 
...
{   
    ...
    public FormCuttingDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    FormCuttingDetailClass.class,
                    FormCuttingDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.linecutting, dtl.namabahan, dtl.ok, dtl.total, dtl.xs, dtl.sm, dtl.l, dtl.xl, dtl.xxl, dtl.xxxl, dtl.qtytotal, dtl.keteranganreject ",    
