...
//import ProblemDomainComponent.LaporanProduksiTypeClass;
...
// uses
    ...
    // has defaulted   
    private LaporanProduksiDetailBrowserClass             browser;   
    ...
    public LaporanProduksiHeaderEditDialogClass( 
        ...
        throws KExceptionClass
{
       ...
       // setSize( 630, 600 );
        ...
        KDialogController = new KDialogControllerClass(                 
                ...
                LaporanProduksiHeaderClass.class, 
                this, getContentPane() );   
    ...
    public void initializeDialog(int dialogModeParam, Long ID, Map foreingKeys ) throws KExceptionClass {
        ...
        JCalendarDemoWidgetAdapterClass dateChooserAdapter = new JCalendarDemoWidgetAdapterClass( jDateChooser1, "GMTDilevery" );                
        KDialogController.includeCustomWidgetForMapping( dateChooserAdapter ); 
      
        JCalendarDemoWidgetAdapterClass dateChooserAdapter1 = new JCalendarDemoWidgetAdapterClass( jDateChooser2, "Tanggal" );                
        KDialogController.includeCustomWidgetForMapping( dateChooserAdapter1 ); 
...
//        JCalendarDemoWidgetAdapterClass dateChooserAdapter3 = new JCalendarDemoWidgetAdapterClass( jDateChooser3, "TglSJ" );                
 ...
 //       JCalendarDemoWidgetAdapterClass dateChooserAdapter4 = new JCalendarDemoWidgetAdapterClass( jDateChooser4, "TglBC" );                
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new LaporanProduksiDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                LaporanProduksiDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        prnoLbl1 = new javax.swing.JLabel();
        qtyLabel1 = new javax.swing.JTextField();
        poqtyLbl = new javax.swing.JLabel();
        prnoLbl2 = new javax.swing.JLabel();
        ...
        okButton.setBounds(440, 100, 80, 20);
        ...
        CancelButton.setBounds(440, 130, 80, 20);
        ...
        applyButton.setBounds(440, 160, 80, 20);
        jLayeredPane1.add(applyButton, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Laporan Produksi", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 10))); // NOI18N
        jPanel1.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N

        jDateChooser1.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        jDateChooser1.setName("GMTDeliveryPick"); // NOI18N

        idLbl.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        idLbl.setText("ID");

        jLabel4.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        jLabel4.setText("GMT Delivery");
        ...
        issuedbyLbl1.setName("AuditUser"); // NOI18N
        ...
        buyeridLbl.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        buyeridLbl.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        buyeridLbl.setName("BuyerID"); // NOI18N

        buyernameLbl.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        ...
        prnoLbl1.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        prnoLbl1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        prnoLbl1.setName("PRID"); // NOI18N

        qtyLabel1.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        qtyLabel1.setName("Description"); // NOI18N

        poqtyLbl.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        poqtyLbl.setText("POQty");

        prnoLbl2.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        prnoLbl2.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        prnoLbl2.setName("POQty"); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, poqtyLbl)
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(prnoLbl1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(prnoLbl2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(pridLbl, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(buyeridLbl, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                            .add(jLabel7)
                            .add(prnoLbl1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                            .add(jLabel6)
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                    .add(poqtyLbl)
                    .add(prnoLbl2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1.setBounds(10, 50, 420, 370);
        ...
        layout.setHorizontalGroup(
            ...
            .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 533, Short.MAX_VALUE)
            .add(DesktopToolbar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 533, Short.MAX_VALUE)
            .add(jScrollPane1)
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(0, 0, 0)
                .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 425, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   LaporanProduksiHeadersamplerecordClassClass po = new LaporanProduksiHeaderClass();
         //   po = (LaporanProduksiHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //LaporanProduksiHeaderClass po = new LaporanProduksiHeaderClass();
            LaporanProduksiHeaderClass ProdIn = ( LaporanProduksiHeaderClass ) POM.copy4( ((LaporanProduksiHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), LaporanProduksiHeaderClass.class );
            
            //materialize Product In Type
  //          persistentObjectManagerClass POMProdInType = new persistentObjectManagerClass(configuration, log);
//            LaporanProduksiTypeClass ProdInType = ( LaporanProduksiTypeClass ) POMProdInType.copy4( ProdIn.getTypeID(), LaporanProduksiTypeClass.class );
            ...
            //LaporanProduksiHeaderTermClass poterm = new LaporanProduksiHeaderTermClass();
            //poterm = (LaporanProduksiHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), LaporanProduksiHeaderTermClass.class );  
...
//                     printJob.printSection( poitem, KPrintJobClass.CENTER );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            outstandingorderBrowserClass oustandingorderBrowser = new outstandingorderBrowserClass(
                configuration, log, new javax.swing.JTable(), this );

            oustandingorderBrowser.initializeTable();

            selectDialogClass selector = new selectDialogClass(
                configuration, log, this, oustandingorderBrowser, "Select Received Order" );
            ...
            else
            {
                ...
                v_Laprod_SelectClass oo = new v_Laprod_SelectClass();                
                oo = (v_Laprod_SelectClass) persistentObjectManager.copy4( parentID, v_Laprod_SelectClass.class );  
                                
                                
                pridLbl.setText(Long.toString(oo.getPRID()));
                prnoLbl.setText(oo.getPRNo());
                buyeridLbl.setText(Long.toString(oo.getBuyerID()));
                buyernameLbl.setText(oo.getBuyerName());
                prnoLbl.setText(oo.getStyle());
                poqtyLbl.setText(Long.toString(oo.getPOQty()));
