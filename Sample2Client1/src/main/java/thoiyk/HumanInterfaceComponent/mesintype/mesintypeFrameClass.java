 ...
 */
public class mesintypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private mesintypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new mesintypeBrowserClass( configuration, log, 
