 ...
 */
public class buyerFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private buyerBrowserClass                browser;
	...
	// has defaulted
	browser =  new buyerBrowserClass( configuration, log, 
