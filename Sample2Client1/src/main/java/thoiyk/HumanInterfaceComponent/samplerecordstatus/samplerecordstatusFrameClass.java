 ...
 */
public class samplerecordstatusFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private samplerecordstatusBrowserClass                browser;
    ...
    public samplerecordstatusFrameClass( 
	...
	// has defaulted
	browser =  new samplerecordstatusBrowserClass( configuration, log, 
        ...
        log.log( this, "samplerecordstatus frame constructed successfully." );     
    }            
