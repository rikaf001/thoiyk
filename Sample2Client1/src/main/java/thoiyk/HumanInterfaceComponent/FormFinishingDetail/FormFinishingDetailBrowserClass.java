...
public class FormFinishingDetailBrowserClass 
...
{   
    ...
    public FormFinishingDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    FormFinishingDetailClass.class,
                    FormFinishingDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.buyerid, dtl.style, dtl.warna, dtl.total, dtl.xs, dtl.sm, dtl.l, dtl.xl, dtl.xxl, dtl.xxxl, dtl.qtytotal, dtl.keteranganreject ",    
