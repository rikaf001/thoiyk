...
import thoiyk.HumanInterfaceComponent.PurchaseOrder.*;
...
public class PurchaseOrderFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private PurchaseOrderBrowserClass             browser;
    ...
    public PurchaseOrderFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new PurchaseOrderBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
