...
public class BTBDetailBrowserClass 
...
{   
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    BTBDetailClass.class,
                    BTBDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 2 tables and joins                                                
                        "btb_dtl btb " +
                        "left join v_po_item poi " +
                        "on " +
                        "btb.itemid=poi.id " +
                        "left join unittype uta " +
                        "on btb.itemunitid=uta.id " +
                        "left join unittype utb " +
                        "on btb.actualunitid=utb.id "+
