...
public class KodeKawasanFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private KodeKawasanBrowserClass             browser;
    ...
    public KodeKawasanFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new KodeKawasanBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
