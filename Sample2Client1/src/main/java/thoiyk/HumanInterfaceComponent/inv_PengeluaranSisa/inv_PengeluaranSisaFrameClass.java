...
public class inv_PengeluaranSisaFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private inv_PengeluaranSisaBrowserClass             browser;
    ...
    public inv_PengeluaranSisaFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new inv_PengeluaranSisaBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
