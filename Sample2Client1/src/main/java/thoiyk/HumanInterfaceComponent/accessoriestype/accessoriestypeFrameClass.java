 ...
 */
public class accessoriestypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private accessoriestypeBrowserClass                browser;
    ...
    public accessoriestypeFrameClass( 
	...
	// has defaulted
	browser =  new accessoriestypeBrowserClass( configuration, log, 
        ...
        log.log( this, "Accessories Type frame constructed successfully." );     
    }            
