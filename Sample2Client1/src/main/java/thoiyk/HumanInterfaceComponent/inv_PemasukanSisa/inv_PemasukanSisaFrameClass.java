...
public class inv_PemasukanSisaFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private inv_PemasukanSisaBrowserClass             browser;
    ...
    public inv_PemasukanSisaFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new inv_PemasukanSisaBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
