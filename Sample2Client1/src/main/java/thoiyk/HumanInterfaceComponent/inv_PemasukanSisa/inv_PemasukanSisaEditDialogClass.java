...
//K
import thoiyk.HumanInterfaceComponent.inv_PemasukanSisa.*;
...
public class inv_PemasukanSisaEditDialogClass
...
implements  KDialogInterface, KDialogEventCallbackInterface
{
    ...
    public inv_PemasukanSisaEditDialogClass( 
...
//                configurationParam, logParam, "image", 1024 /* 1Kb start size, its dynamic dont worry */ );
 ...
 //       KDialogController.addNonVisibleWidget( productPictureRawDataContainer );
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Pemasukan Barang Sisa", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11))); // NOI18N
