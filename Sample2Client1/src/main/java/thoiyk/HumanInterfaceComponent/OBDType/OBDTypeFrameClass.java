 ...
 */
public class OBDTypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private OBDTypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new OBDTypeBrowserClass( configuration, log, 
