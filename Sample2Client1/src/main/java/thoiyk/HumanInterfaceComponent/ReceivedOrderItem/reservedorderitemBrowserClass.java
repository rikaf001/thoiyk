...
{   
    ...
    {	      
            ...
            if( mode == SRITEM_BY_SR ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " sri.id , vsri.subcategory,vsri.nama itemname, sri.qty,ut.nama unit, sri.comp, sri.tolerance,sri.qtyneed ",    

                        // 2 tables and joins                                                
                        " receivedorderitem sri " +
            ...
            adjustColumnWidth( "SubCategory", 150 );
