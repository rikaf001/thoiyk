...
import ProblemDomainComponent.CuttingDailyRepDtlSizeClass;
...
public class CuttingDailyRepDtlSizeBrowserClass 
...
{   
    ...
    public CuttingDailyRepDtlSizeBrowserClass(
            KConfigurationClass configurationParam,
            KLogClass logParam,
            JTable tableParam,            
            int modeParam, long HdrIDparam,            
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    CuttingDailyRepDtlSizeClass.class,
                    CuttingDailyRepDtlEditSizeDialogClass.class
            );  
    ...
    {	      
            ...
            if( mode == POITEM_BY_PO ){   
              ...
              " dts.id,dts.warna,dts.ukuran,dts.qty ",
              " CUTTINGDAILYREP_DTLSIZE dts " ,
...
*/                  
                ...
                bindDefaultParameter1( ":hdrid",  HdrID  );     
...
//                               productID = selector.showDialog();
                               ...
                               if( HdrID == -1 ) throw new KExceptionClass( "You must select a production record for the pr_newitem!", null);
                        }
