...
public class BarangKeluarJadiDetailBrowserClass 
...
{   
    ...
    public BarangKeluarJadiDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    BarangKeluarJadiDetailClass.class,
                    BarangKeluarJadiDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        "bkb.id, bkb.barangnama, ut.nama unit,bkb.qty, bkb.hargasatuan ",    

                        // 2 tables and joins                                                
                        "barangkeluarjadi_dtl bkb "+
                            " left join unittype ut on ut.id=bkb.unitid",
