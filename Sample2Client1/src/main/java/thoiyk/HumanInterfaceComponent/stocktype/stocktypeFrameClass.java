 ...
 */
public class stocktypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private stocktypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new stocktypeBrowserClass( configuration, log, 
