...
import ProblemDomainComponent.FormSewingHeaderClass;
...
public class FormSewingHeaderEditDialogClass 
...
// uses
    ...
    // has defaulted   
    private FormSewingDetailBrowserClass             browser;   
    ...
    public FormSewingHeaderEditDialogClass( 
...
//        JCalendarDemoWidgetAdapterClass dateChooserAdapter3 = new JCalendarDemoWidgetAdapterClass( jDateChooser3, "TglSJ" );                
 ...
 //       JCalendarDemoWidgetAdapterClass dateChooserAdapter4 = new JCalendarDemoWidgetAdapterClass( jDateChooser4, "TglBC" );                
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new FormSewingDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                FormSewingDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Form Sewing", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 10))); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .add(printGraphButton1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                .addContainerGap())
        );
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                            ...
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup()
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                    .add(org.jdesktop.layout.GroupLayout.LEADING, client_id6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
        ...
        jPanel1.setBounds(0, 50, 430, 260);
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(1, 1, 1)
                .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 317, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   FormSewingHeadersamplerecordClassClass po = new FormSewingHeaderClass();
         //   po = (FormSewingHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //FormSewingHeaderClass po = new FormSewingHeaderClass();
            FormSewingHeaderClass ProdIn = ( FormSewingHeaderClass ) POM.copy4( ((FormSewingHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), FormSewingHeaderClass.class );
            
            //materialize Product In Type
  //          persistentObjectManagerClass POMProdInType = new persistentObjectManagerClass(configuration, log);
//            FormSewingTypeClass ProdInType = ( FormSewingTypeClass ) POMProdInType.copy4( ProdIn.getTypeID(), FormSewingTypeClass.class );
            ...
            //FormSewingHeaderTermClass poterm = new FormSewingHeaderTermClass();
            //poterm = (FormSewingHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), FormSewingHeaderTermClass.class );  
