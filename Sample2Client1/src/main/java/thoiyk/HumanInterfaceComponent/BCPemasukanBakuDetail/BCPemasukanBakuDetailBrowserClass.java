...
public class BCPemasukanBakuDetailBrowserClass 
...
{   
    ...
    public BCPemasukanBakuDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    v_BC_PemasukanBakuDetailClass.class,
                    BCPemasukanBakuDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        "bts.id,bts.hdrid,bts.category,bts.description,bts.unit,bts.itemqty ",    

                        // 2 tables and joins                                                
                        " V_BC_PEMASUKAN_BAKU_DTL bts " ,
