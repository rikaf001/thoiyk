...
public class SummaryRepSewingHdrFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private SummaryRepSewingHdrBrowserClass             browser;
    ...
    public SummaryRepSewingHdrFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new SummaryRepSewingHdrBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
