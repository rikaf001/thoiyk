...
// uses
    ...
    // has defaulted   
    private FormShippingDetailBrowserClass             browser;   
    ...
    public FormShippingHeaderEditDialogClass( 
        ...
        throws KExceptionClass
{
    ...
    public void initializeDialog(int dialogModeParam, Long ID, Map foreingKeys ) throws KExceptionClass {
        ...
        JCalendarDemoWidgetAdapterClass dateChooserAdapter2 = new JCalendarDemoWidgetAdapterClass( jDateChooser2, "TglBC" );                
 ...
 //       JCalendarDemoWidgetAdapterClass dateChooserAdapter4 = new JCalendarDemoWidgetAdapterClass( jDateChooser4, "TglBC" );                
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new FormShippingDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                FormShippingDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        LblROID = new javax.swing.JLabel();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Form Shipping", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 10))); // NOI18N
        ...
        LblROID.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        LblROID.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        LblROID.setName("ROID"); // NOI18N
        ...
        jTextArea1.setName("Remarks"); // NOI18N
        ...
        cbMataUang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "???" }));
        cbMataUang.setName("TypeIDSelect"); // NOI18N
        ...
        jLabel7.setText("MataUang");

        jLabel9.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        jLabel9.setText("JenisDok");

        cbJenisDok.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        cbJenisDok.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "???" }));
        ...
        jLabel11.setText("Kawasan");

        cbKawasan.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        cbKawasan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "???" }));
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        .add(pridLbl, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 222, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(stylenameLbl, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 222, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(LblROID, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 59, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, client_id6, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 59, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jButton2)))
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(qtyLabel14, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                    .add(jPanel1Layout.createSequentialGroup()
                    ...
                    .add(issuedbyLbl, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                    ...
                    .add(cbMataUang, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(cbJenisDok, 0, 333, Short.MAX_VALUE)
                    .add(cbKawasan, 0, 333, Short.MAX_VALUE)
                    .add(jDateChooser2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                    .add(jScrollPane2))
                .addContainerGap())
        );
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                            .add(jLabel3)
                            .add(LblROID, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jButton2))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.CENTER)
                            .add(jLabel6)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                .add(jLayeredPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 492, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   FormShippingHeadersamplerecordClassClass po = new FormShippingHeaderClass();
         //   po = (FormShippingHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //FormShippingHeaderClass po = new FormShippingHeaderClass();
            FormShippingHeaderClass ProdIn = ( FormShippingHeaderClass ) POM.copy4( ((FormShippingHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), FormShippingHeaderClass.class );
            
            //materialize Product In Type
  //          persistentObjectManagerClass POMProdInType = new persistentObjectManagerClass(configuration, log);
//            FormShippingTypeClass ProdInType = ( FormShippingTypeClass ) POMProdInType.copy4( ProdIn.getTypeID(), FormShippingTypeClass.class );
            ...
            //FormShippingHeaderTermClass poterm = new FormShippingHeaderTermClass();
            //poterm = (FormShippingHeaderTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), FormShippingHeaderTermClass.class );  
...
//                     printJob.printSection( poitem, KPrintJobClass.CENTER );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            outstandingorderBrowserClass ROBrowser = new outstandingorderBrowserClass(
                configuration, log, new javax.swing.JTable(), this );

            ROBrowser.initializeTable();

            selectDialogClass selector = new selectDialogClass(
                configuration, log, this, ROBrowser, "Select Received Order" );
            ...
            else
            {
                ...
                LblROID.setText( Long.toString(parentID) );
                LblBuyerID.setText(Long.toString(ro.getBuyerid()));
                LblBuyerName.setText(buyer.getNama());
                stylenameLbl.setText(ro.getStyle());
    ...
    private javax.swing.JLabel LblROID;
