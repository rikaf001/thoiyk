...
public class BRSHeaderFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BRSHeaderBrowserClass             browser;
    ...
    public BRSHeaderFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BRSHeaderBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
