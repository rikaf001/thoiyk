...
public class BarangMasukJadiFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangMasukJadiBrowserClass             browser;
    ...
    public BarangMasukJadiFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangMasukJadiBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
