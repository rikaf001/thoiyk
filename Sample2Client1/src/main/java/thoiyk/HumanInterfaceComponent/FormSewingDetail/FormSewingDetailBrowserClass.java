...
public class FormSewingDetailBrowserClass 
...
{   
    ...
    public FormSewingDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    FormSewingDetailClass.class,
                    FormSewingDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.nama, dtl.warna, dtl.qtyorder, dtl.qtyallowance, dtl.cut,dtl.given, dtl.actual, dtl.datang, dtl.butuh, dtl.plusmin, dtl.persen, dtl.keterangan ",    
