...
package thoiyk.HumanInterfaceComponent.FormSewingDetail;
...
import ProblemDomainComponent.FormSewingDetailClass;
...
public class FormSewingDetailEditDialogClass 
...
implements KDialogInterface
{
    ...
    public FormSewingDetailEditDialogClass( 
...
//        setSize( 630, 600 );
        ...
        KDialogController = new KDialogControllerClass(                 
                configuration, log, 
                FormSewingDetailClass.class, this, getContentPane() );        
    ...
    private void initComponents() {
        ...
        lblTelp.setText("Nama");

        qtyLabel.setName("Nama"); // NOI18N
        ...
        qtyLabel5.setName("Given"); // NOI18N

        lblTelp8.setText("Actual");

        qtyLabel6.setName("Actual"); // NOI18N
        ...
        qtyLabel9.setName("Datang"); // NOI18N

        lblTelp13.setText("Butuh");

        qtyLabel10.setName("Butuh"); // NOI18N

        lblTelp14.setText("+ / -");

        qtyLabel11.setName("PlusMin"); // NOI18N

        lblTelp15.setText("%");

        qtyLabel12.setName("Persen"); // NOI18N
