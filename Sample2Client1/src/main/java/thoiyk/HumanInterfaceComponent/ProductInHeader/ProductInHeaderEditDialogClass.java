...
import ProblemDomainComponent.ProductInTypeClass;
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
         ...
         //   po = (ProductInHeaderClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  
            ...
            ProductInHeaderClass ProdIn = ( ProductInHeaderClass ) POM.copy4( ((ProductInHeaderClass)KDialogController.getCurrentObjectDisplayed()).getID(), ProductInHeaderClass.class );
...
//            
            ...
            headerSection.printText(ProdInType.getNama(),          170, 100 );
