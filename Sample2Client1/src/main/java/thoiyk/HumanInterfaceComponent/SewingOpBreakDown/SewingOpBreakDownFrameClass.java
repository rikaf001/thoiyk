...
public class SewingOpBreakDownFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private SewingOpBreakDownBrowserClass             browser;
    ...
    public SewingOpBreakDownFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new SewingOpBreakDownBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
