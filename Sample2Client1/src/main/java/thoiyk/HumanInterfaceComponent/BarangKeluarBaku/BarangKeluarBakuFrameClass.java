...
public class BarangKeluarBakuFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangKeluarBakuBrowserClass             browser;
    ...
    public BarangKeluarBakuFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangKeluarBakuBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
