...
import ProblemDomainComponent.BarangKeluarBakuClass;
...
import thoiyk.HumanInterfaceComponent.BarangKeluarBakuDetail.BarangKeluarBakuDetailBrowserClass;
...
public class BarangKeluarBakuEditDialogClass 
...
// uses
    ...
    // has defaulted   
    private BarangKeluarBakuDetailBrowserClass             browser;   
    ...
    public BarangKeluarBakuEditDialogClass( 
        ...
        throws KExceptionClass
{
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new BarangKeluarBakuDetailBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                BarangKeluarBakuDetailBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Barang Keluar Baku", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 10))); // NOI18N
        ...
        Supplier_Text04Edit1.setName("SJNo"); // NOI18N
        ...
        jLabel20.setText("Kawasan");

        cbKawasan.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        cbKawasan.setName("KawasanType"); // NOI18N
        ...
        Supplier_Text04Edit3.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        Supplier_Text04Edit3.setName("Catatan"); // NOI18N
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    .add(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                            .add(cbKawasan, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 172, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                ...
                                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    ...
                                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                            ...
                                            .add(org.jdesktop.layout.GroupLayout.LEADING, Supplier_Text04Edit1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 145, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(jLabel22)
                        .add(50, 50, 50)
                        .add(Supplier_Text04Edit3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 283, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel1Layout.createSequentialGroup()
                                ...
                                .add(jLabel19))
                            .add(jPanel1Layout.createSequentialGroup()
                                .add(cbKawasan, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void printGraphButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printGraphButton1ActionPerformed
      ...
      try{
            ...
            //materialize the sdg
         //   BarangKeluarBakusamplerecordClassClass po = new BarangKeluarBakuClass();
         //   po = (BarangKeluarBakuClass) persistentObjectManager.copy4( sdg_id, ASHURSampleDeliveryGroupClass.class );  

            persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
            //BarangKeluarBakuClass po = new BarangKeluarBakuClass();
            BarangKeluarBakuClass ProdIn = ( BarangKeluarBakuClass ) POM.copy4( ((BarangKeluarBakuClass)KDialogController.getCurrentObjectDisplayed()).getID(), BarangKeluarBakuClass.class );
            ...
            //BarangKeluarBakuTermClass poterm = new BarangKeluarBakuTermClass();
            //poterm = (BarangKeluarBakuTermClass) persistentObjectManager.copy4( po.getTermPaymentID(), BarangKeluarBakuTermClass.class );  
