...
import thoiyk.HumanInterfaceComponent.SewingThreadCount.SewingThreadCountBrowserClass;



public class SewingThreadCountDtlBrowserClass 
...
{   
    ...
    public SewingThreadCountDtlBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    SewingThreadCountDtlClass.class,
                    SewingThreadCountDtlEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        "dtl.id, dtl.threadname,dtl.ukuran,dtl.part,dtl.remark,dtl.totalinch,dtl.totalmeter ",    

                        // 2 tables and joins                                                
                        "SEWINGTHREADCOUNTDTL dtl" ,
                ...
                // when not inside a client edit dialog
                        ...
                        if( mode == ALL_POITEM ){
                            ...
                            // build a client browser
                               SewingThreadCountBrowserClass pr_new = new SewingThreadCountBrowserClass(
