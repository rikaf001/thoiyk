 ...
 */
public class SizeTypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private SizeTypeBrowserClass                browser;
	...
	// has defaulted
	browser =  new SizeTypeBrowserClass( configuration, log, 
