...
public class SewingThreadCountFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private SewingThreadCountBrowserClass             browser;
    ...
    public SewingThreadCountFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new SewingThreadCountBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
