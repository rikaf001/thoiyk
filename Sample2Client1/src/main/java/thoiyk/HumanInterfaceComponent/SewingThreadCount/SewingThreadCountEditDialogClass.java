...
// uses
    ...
    // has defaulted   
    private SewingThreadCountDtlBrowserClass             browser;   
    ...
    public SewingThreadCountEditDialogClass( 
...
//        JCalendarDemoWidgetAdapterClass dateChooserAdapter3 = new JCalendarDemoWidgetAdapterClass( jDateChooser3, "TglSJ" );                
 ...
 //       JCalendarDemoWidgetAdapterClass dateChooserAdapter4 = new JCalendarDemoWidgetAdapterClass( jDateChooser4, "TglBC" );                
    ...
    public void setupTables(long id) throws KExceptionClass {
        ...
        browser = new SewingThreadCountDtlBrowserClass( 
                //
                 configuration, log,
                POItemBrowserJTable,
                SewingThreadCountDtlBrowserClass.POITEM_BY_PO, 
                id,
...
//        saveChangesButton1.setEnabled( true);        
    ...
    private void initComponents() {
        ...
        LblStyleName.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        LblStyleName.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        LblStyleName.setName("StyleName"); // NOI18N
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jLabel6)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(LblStyleName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 214, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel1Layout.createSequentialGroup()
                        .add(77, 77, 77)
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel1Layout.createSequentialGroup()
            ...
            .add(jPanel1Layout.createSequentialGroup()
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jLabel6)
                            .add(LblStyleName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)))
                .add(jLabel17)
                .add(3, 3, 3)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            ...
            else
            {
                ...
                LblStyleName.setText(pr.getStyle());
