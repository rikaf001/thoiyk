...
public class MutasiSisaFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private MutasiSisaBrowserClass             browser;
    ...
    public MutasiSisaFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new MutasiSisaBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
