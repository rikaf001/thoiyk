...
public class FormFinishingHeaderFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private FormFinishingHeaderBrowserClass             browser;
    ...
    public FormFinishingHeaderFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new FormFinishingHeaderBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
