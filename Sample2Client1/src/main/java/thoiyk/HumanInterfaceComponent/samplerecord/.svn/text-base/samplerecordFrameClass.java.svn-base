...
public class productFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private productBrowserClass             browser;
    ...
    public productFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new productBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
