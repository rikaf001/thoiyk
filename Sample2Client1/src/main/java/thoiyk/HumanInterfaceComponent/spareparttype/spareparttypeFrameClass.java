 ...
 */
public class spareparttypeFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private spareparttypeBrowserClass                browser;
    ...
    public spareparttypeFrameClass( 
	...
	// has defaulted
	browser =  new spareparttypeBrowserClass( configuration, log, 
