...
public class SewingOpBreakDownDtlBrowserClass 
...
{   
    ...
    public SewingOpBreakDownDtlBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    SewingOpBreakDownDtlClass.class,
                    SewingOpBreakDownDtlEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id,dtl.audituser,dtl.auditdate ",    
