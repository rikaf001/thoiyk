...
public class FabricRequestHdrFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private FabricRequestHdrBrowserClass             browser;
    ...
    public FabricRequestHdrFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new FabricRequestHdrBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
