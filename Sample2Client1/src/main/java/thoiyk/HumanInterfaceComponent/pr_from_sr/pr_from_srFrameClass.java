...
public class pr_from_srFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private pr_from_srBrowserClass             browser;
    ...
    public pr_from_srFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new pr_from_srBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
