...
public class ServiceFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private ServiceBrowserClass             browser;
    ...
    public ServiceFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new ServiceBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
