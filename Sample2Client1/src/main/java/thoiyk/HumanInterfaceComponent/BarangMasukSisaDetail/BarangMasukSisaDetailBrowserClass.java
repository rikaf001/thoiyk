...
public class BarangMasukSisaDetailBrowserClass 
...
{   
    ...
    public BarangMasukSisaDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    BarangMasukSisaDetailClass.class,
                    BarangMasukSisaDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        "bkb.id, bkb.barangnama, ut.nama unit,bkb.qty ",    

                        // 2 tables and joins                                                
                        "barangmasuksisa_dtl bkb "+
