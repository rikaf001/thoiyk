...
package thoiyk.HumanInterfaceComponent.BarangMasukSisaDetail;
...
import ProblemDomainComponent.BarangMasukSisaDetailClass;
import ProblemDomainComponent.v_Select_BrngMskSisaDtlClass;
//import ProblemDomainComponent.productionrecordClass;
import java.util.Map;
import thoiyk.HumanInterfaceComponent.buyer.buyerBrowserClass;
import thoiyk.HumanInterfaceComponent.v_Select_BarangMasukSisaDetail.v_Select_BarangMasukSisaDetailBrowserClass;
//import thoiyk.HumanInterfaceComponent.PurchaseOrder.PurchaseOrderBrowserClass;

// rtl


public class BarangMasukSisaDetailEditDialogClass 
...
implements KDialogInterface
{
    ...
    public BarangMasukSisaDetailEditDialogClass( 
...
//        setSize( 630, 600 );
        ...
        KDialogController = new KDialogControllerClass(                 
                configuration, log, 
                BarangMasukSisaDetailClass.class, this, getContentPane() );        
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Barang Masuk Sisai Detail", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 10))); // NOI18N
...
private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
            v_Select_BarangMasukSisaDetailBrowserClass itemBrowser = new v_Select_BarangMasukSisaDetailBrowserClass(
            ...
            else
            {
                ...
                persistentObjectManagerClass POM = new persistentObjectManagerClass(configuration, log);
                v_Select_BrngMskSisaDtlClass brng = new v_Select_BrngMskSisaDtlClass();
                barangidLbl.setText( Long.toString(parentID));
                brng = ( v_Select_BrngMskSisaDtlClass ) POM.copy4( parentID, v_Select_BrngMskSisaDtlClass.class );
