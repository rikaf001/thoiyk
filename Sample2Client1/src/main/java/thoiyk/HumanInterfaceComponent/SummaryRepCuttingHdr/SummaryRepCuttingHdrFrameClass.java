...
public class SummaryRepCuttingHdrFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private SummaryRepCuttingHdrBrowserClass             browser;
    ...
    public SummaryRepCuttingHdrFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new SummaryRepCuttingHdrBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
