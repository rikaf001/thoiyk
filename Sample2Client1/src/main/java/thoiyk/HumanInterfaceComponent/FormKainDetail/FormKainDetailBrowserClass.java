...
public class FormKainDetailBrowserClass 
...
{   
    ...
    public FormKainDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    FormKainDetailClass.class,
                    FormKainDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.jeniskain, dtl.warna, dtl.qtyorder, dtl.qtyallowance, dtl.qtycut, dtl.consumtiongiven, dtl.consumtionactual, dtl.kaindatang, dtl.kainbutuh, dtl.kainplusmin, dtl.kainpersen, dtl.keterangan ",    
