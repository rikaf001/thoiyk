...
public class BarangDalamProsesFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private BarangDalamProsesBrowserClass             browser;
    ...
    public BarangDalamProsesFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new BarangDalamProsesBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
