...
public class CuttingDailyRepHdrFrameClass 
...
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private CuttingDailyRepHdrBrowserClass             browser;
    ...
    public CuttingDailyRepHdrFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new CuttingDailyRepHdrBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
