...
public class BKBHeaderBRPBrowserClass 
extends KDataBrowserBaseClass {   
    ...
    public BKBHeaderBRPBrowserClass(
    ...
    {	      
            ...
            super.initializeSQLQuery( 
                ...
                "  pr.ID, pr.nomor, pr.tanggal, tr.nama pemberi, pr.nobc, pr.tglbc  ",
            ...
            setColumnNames( "sup", "PEMBERI", "Pemberi" );
