 ...
 */
public class supplierFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private supplierBrowserClass                browser;
	...
	// has defaulted
	browser =  new supplierBrowserClass( configuration, log, 
        ...
        log.log( this, "Supplier frame constructed successfully." );     
    }            
