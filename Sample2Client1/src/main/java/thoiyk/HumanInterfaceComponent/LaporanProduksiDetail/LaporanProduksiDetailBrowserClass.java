...
public class LaporanProduksiDetailBrowserClass 
...
{   
    ...
    public LaporanProduksiDetailBrowserClass(
            ...
            java.awt.Window parentWindow ) throws KExceptionClass
    {
            ...
            super(
                    ...
                    LaporanProduksiDetailClass.class,
                    LaporanProduksiDetailEditDialogClass.class
            );  
            ...
            if( mode == POITEM_BY_PO ){   
                ...
                if( configuration.getField("databaseType").equals( "oracle" )  ){
                    ...
                    super.initializeSQLQuery(     
                        ...
                        // 1 fields                    
                        " dtl.id, dtl.buyerid, dtl.buyername, dtl.style, dtl.color, dtl.xs, dtl.s, dtl.m, dtl.l, dtl.xl, dtl.xxl, dtl.xxxl, dtl.reject ",    

                        // 2 tables and joins                                                
                        " laporanproduksi_dtl dtl " ,
