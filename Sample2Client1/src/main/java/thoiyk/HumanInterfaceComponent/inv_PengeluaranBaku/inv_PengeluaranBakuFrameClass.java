...
public class inv_PengeluaranBakuFrameClass extends javax.swing.JInternalFrame 
implements desktopToolbarListenerInterface, InternalFrameListener
{
	...
	// has - defaulted
	private inv_PengeluaranBakuBrowserClass             browser;
    ...
    public inv_PengeluaranBakuFrameClass(KConfigurationClass configurationParam,KLogClass logParam,desktopAccessInterface systemDesktopParam ) throws KExceptionClass
    {        
        initComponents ();
	...
	// has defaulted
	browser =  new inv_PengeluaranBakuBrowserClass( configuration, log, justificationTable, mainToolbar.getDesktopsWindow()  );                           
